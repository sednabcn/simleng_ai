...
class Drawing2d:
    ...
    def plot_matrix_matrix(X,Y,Title,xlabel,ylabel,Labels,\
                           Linestyle,kind,scale,grid,text,boxstyle,mode=None):
...
class Draw_binary_classification_results:
    ...
    def roc_curve(self):
        ...
        Linestyle=['-','-.','--',':','--']
        return Drawing2d.plot_matrix_matrix(X,Y,Title,xlabel,ylabel,Labels,Linestyle,0,'equal','','','','')
    ...
    def fpn_estimated(self):
        ...
        Linestyle=['-','-.','--',':','--']
        return Drawing2d.plot_matrix_matrix(X,Y,Title,xlabel,ylabel,Labels,Linestyle,2,'equal','','','','')
