...
for data in Datasets:
    ...
    for indicator in features_treshold:
        ...
        if data=='Ionosphere':
          best_predictors_list=Best_features_filter.show_best_pca_predictors(X_transf,X_transf.shape[1],treshold)
        else:
         best_predictors_list=Best_features_filter.show_best_pca_predictors(X_train,X_train.shape[1],treshold)
    ...
    table(AUC_t,'.2f','fancy_grid','AUC-TOP ROC CURVE [TOP] in '+ data +' Dataset', 40)
