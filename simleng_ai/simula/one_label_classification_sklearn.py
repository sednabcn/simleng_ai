...
class One_label_classification_sklearn(Data_Generation):
    ...
    def one_label_classification_sklearn_master(self):
        print(self.proc)
    ...
    def binary_classifiers(self):
        ...
        # plot_binary_classsifiers_comparison _on_the_first_two_pca_components
        if self.idoc >= 1:
            print("Fig:binary_classifiers_comparison")
