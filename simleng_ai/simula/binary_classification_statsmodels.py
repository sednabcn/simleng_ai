...
class Binary_classification_statsmodels(Data_Generation):
    ...
    def binary_classification_statsmodels_master(self):
        print(self.proc)
        # print(self.data_train.values())
        # print(self.data_dummy_train.values())
        method_name = "binary_classification_" + str(self.proc)
        print(method_name)
