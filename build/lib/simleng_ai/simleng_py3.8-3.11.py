...
class Simleng:
    ...
    def __init__(self,file_input,score=None):
        ...
        _,self.dataset,_,_,self.features,\
                        self.target,self.strategies_client=self.gen.get_input_info()
    ...
    def strategies_features_master(self):            
        ...
        if self.strategies_client["STRATEGY"]=="Features_selection":                                       
            return Features_selection(*[self.data_train,self.data_test,self.data_dummy_train,\
                                       self.data_dummy_test,self.strategies_client["METHOD"]]).\
